(function (global, factory) {
    ...
    const obj = $(ele).css({
        'transition': 'all 0.1s', '-moz-transition': 'all 0.1s', '-webkit-transition': 'all 0.1s', '-o-transition': 'all 0.1s', position: 'absolute', cursor: 'pointer',
        // left: 0, top: 0
...
function scaleFunc(val, origin,event) {
    scale += (val * scale);
