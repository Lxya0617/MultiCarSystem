  ...
  <div id="BillInfo" class="bill-info">
    <div class="btn-con">
        <div class="r1-con">
            ...
            <Row class="r1">
            <Col span="10">
                <DatePicker type="date" style="width: 100%"  :editable="false" :clearable="false"  v-model="StartDate"></DatePicker>
            </Col>
        ...
        <div class="r2-con">
            ...
            <Row class="r2">
            <Col span="10">
            <DatePicker type="date" style="width: 100%" :editable="false" :clearable="false" v-model="EndDate" format="yyyy-MM-dd" ></DatePicker>
            </Col>
            <Col span="2" style="text-align: center">-</Col>
            <Col span="4">
      ...
      <Button type="primary" icon="ios-search" @click="serchHandler" >查询</Button>
      <Divider />
    </div>
    <div class="robot-con">
      <div class="lsit">
...
export default {
  ...
  methods: {
    ...
    serchHandler(){
        ...
        reqData.StartTime=StartTime+Number(this.startHour)*3600+Number(this.startMinute*60)-8*3600
        //结束时间
        ...
        reqData.EndTime=EndTime+Number(this.EndHour)*3600+Number(this.EndMinute*60)-8*3600
